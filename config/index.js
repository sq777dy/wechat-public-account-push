export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx8aa8959d02d217b5",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "5fad599ee8038ae32c33bba31d16c37e",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "生日", "name": "周立琳宝贝", "year": "2003", "date": "03-08", isShowAge: true},
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
        // 来到这个世界的日子
        {"keyword": "BIR_day", date: "2003-03-08"},
        // 恋爱纪念日
